...
const navItems: NavItem[] = [
    { label: "Home", url: "/", publicOnly: true },
    { label: "Login", url: "/login", publicOnly: true },
...
function Navigation() {
    ...
    const drawer = (
        <Box maxWidth="xs" onClick={handleDrawerToggle} sx={{ textAlign: "center" }}>
